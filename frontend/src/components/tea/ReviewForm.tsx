...
export default function ReviewForm({
  ...
  teaId: string;
  onNewReview: (review: IPopulatedReview) => void;
}) {
  ...
  return (
    <section>
      ...
      <form onSubmit={handleSubmit}>
        <textarea
          className="w-full mb-3 p-2 border-b border-green-accent rounded-md bg-charcoal"
          rows={3}
        ...
        <div>
          ...
          <button className="bg-green-accent rounded-xl py-2 px-4 mx-4">
            Submit
          </button>
        </div>
      </form>
